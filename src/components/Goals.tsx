    ...
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap items-center gap-2">
        <input
          ...
          className="min-w-[160px] flex-1 rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm placeholder:text-neutral-400 focus:border-neutral-400"
        />
        <input
          value={target}
          ...
          placeholder="Target"
          type="number"
          className="w-20 rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm placeholder:text-neutral-400 focus:border-neutral-400"
        />
        <input
          value={unit}
                ...
                <div className="flex items-center justify-between text-xs text-neutral-500">
                  ...
                  <div className="flex items-center gap-1">
                    <button
                      ...
                      className="flex h-6 w-6 items-center justify-center rounded-md border border-neutral-200 hover:bg-neutral-50"
                    >
                      <Minus size={12} />
                    </button>
                    <button
